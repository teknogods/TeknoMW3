...
class ISteamMatchmaking003_wrapper
{
public:
	...
	virtual OBSOLETE_FUNCTION void  SetLobbyVoiceEnabled ( CSteamID steamIDLobby,  bool bEnabled )	{
		char log[1024];
		sprintf(log,"SetLobbyVoiceEnabled() steamIDLobby=0x%X bEnabled=0x%X ",
			steamIDLobby,
			bEnabled		);
		OutputDebugStringA(log);
		steamIDLobby, bEnabled);
		OutputDebugStringA("\n");
	}
