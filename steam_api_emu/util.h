...
extern bool FindHexString_Quiet;
...
typedef struct _NET_ADDRESS_LIST {
	int iAddressCount;
	SOCKET_ADDRESS Address[64];
} NET_ADDRESS_LIST, *PNET_ADDRESS_LIST;

PNET_ADDRESS_LIST EnumNetworkAdapters();
extern NET_ADDRESS_LIST g_IpList;
extern int g_DefaultInterface;
